...
list_of_preds <- list()
list_of_preds[[39]] = readRDS(paste0("preds_buy_", 39))
list_of_preds[[40]] = readRDS(paste0("preds_buy_", 40))
list_of_preds[[42]] = readRDS(paste0("preds_buy_", 42))
...
result <- objToOptimize(c(10, 10, 0.16, 500))
saveRDS(result, file = "Result_TESTING_Buy_ML_Algo")
